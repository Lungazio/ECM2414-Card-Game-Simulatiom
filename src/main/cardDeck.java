 ...
 */
 ...
 //card deck acts like a player but does not have pref of cards and will always give the top card and always append to the bottom
//card deck removes cards = player taking a card from the deck and when the 
